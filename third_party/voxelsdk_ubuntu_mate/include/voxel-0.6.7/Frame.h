...
class VOXEL_EXPORT ToFRawFrameTemplate : public ToFRawFrame
{
public:
...
class VOXEL_EXPORT ToFRawIQFrameTemplate : public ToFRawIQFrame
{
public:
  Vector<ByteType> _i;
  Vector<ByteType> _q;
...
class VOXEL_EXPORT PointCloudFrameTemplate : public PointCloudFrame
{
public:
