...
#ifndef VOXEL_USBSYSTEMPRIVATEANDROID_H
#define VOXEL_USBSYSTEMPRIVATEANDROID_H
...
public:
  USBSystemPrivate()
  {
    ...
    {
      std::cerr << "Initialization of USB library failed" << ret<< std::endl;
      _context = 0;
      return;
    }
  }
...
#endif // USBSYSTEMPRIVATEANDROID_H
